...
{
    private ChamadoRepositoryEmArquivo repositorioChamado;
    ...
    public ChamadoController()
    {
        ...
        this.repositorioChamado = new ChamadoRepositoryEmArquivo(contexto);
        this.repositorioEquipamento = new EquipamentoRepositoryEmArquivo(contexto);
    }
